...
from scorenet.scorenet1d import FNO1d
import argparse
import logging
...
def plot_forward_reverse_comparison(forward_gt, forward_pred, reverse_gt, reverse_pred, base_save_path):
    ...
    for idx_idx, sample_idx in enumerate(rand_indices, 1):
        # 正向推理图
        ...
        # 修正后的刻度字体配置
        ax_forward.set_xticks(ax_forward.get_xticks())
        ax_forward.set_xticklabels(ax_forward.get_xticklabels(), fontsize=16)
        ax_forward.set_yticks(ax_forward.get_yticks())
        ax_forward.set_yticklabels(ax_forward.get_yticklabels(), fontsize=16)
        ...
        # 修正后的刻度字体配置
        ax_reverse.set_xticks(ax_reverse.get_xticks())
        ax_reverse.set_xticklabels(ax_reverse.get_xticklabels(), fontsize=16)
        ax_reverse.set_yticks(ax_reverse.get_yticks())
        ax_reverse.set_yticklabels(ax_reverse.get_yticklabels(), fontsize=16)
