...
from rfo_demo.data import BurgersDataset
...
TRAIN_DATA_PATH = "/data5/store1/dlt/rectified_flow/data/burgers_data_R10.mat"
TEST_DATA_PATH = TRAIN_DATA_PATH



def _build_loaders(batch_size: int, target_len: int):
    train_dataset = BurgersDataset(TRAIN_DATA_PATH, mode="train", target_len=target_len)
    test_dataset = BurgersDataset(TEST_DATA_PATH, mode="test", target_len=target_len)
